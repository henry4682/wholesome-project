...
import { BsSearch ,BsFillPersonFill,BsStarFill,BsStarHalf,BsStar} from 'react-icons/bs';
      ...
      <div className="container row">
        <div className="main col-12 col-md-8 col-lg-8 ">
          ...
          <div className='recipe-image mt-5'>
              ...
              <button type="button" class="btn btn-outline-secondary">收藏</button>
          </div>
          ...
          <div className='recipe-steps mt-5'>
            ...
            <div className='step d-flex row'>
              <div className='step-image col-12 col-md-4'>
                <img src={recipeImage}></img>
              </div>
              <div className='step-text col-12 col-md-8'>
          ...
          <div className='recipe-review mt-5'>
            ...
            <div className='review'>
              ...
              <div className='review-info d-flex justify-content-between'>
                ...
                <div className='review-stars'><BsStarFill/><BsStarFill/><BsStarFill/><BsStarFill/><BsStarFill/></div>
              </div>
              <hr/> 
            </div>
            <div className='review'>
        ...
        <div className="sidebar col-0 col-md-4 col-lg-4 ">
